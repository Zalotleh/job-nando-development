...
export default async function certificateDescriptionTunning(req,res) {
    ...
    try {
        ...
        const certificateResponse = await openAi.createChatCompletion({
          ...
          messages:[
              ...
              {"role":"user","content":`I am writing my resume and i need you to improve my certificate description here ${text}, please provide only the improved text, no side talk. `}, 
